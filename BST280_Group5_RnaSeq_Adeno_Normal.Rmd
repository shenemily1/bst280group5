...
PCA_filter_prebatch <- prcomp(t(assayData(filtered_eset)[["count"]]))
# PCA after batch correction
PCA_filter_postbatch <- prcomp(t(assayData(filtered_eset)[["logtpm"]]))
...
expr_mat <- assayData(filtered_eset)[["logtpm"]]
...
```{r, warning=FALSE, message=FALSE}
expr <- assayData(filtered_eset)[["logtpm"]]
...
```{r}
expr_mat <- assayData(filtered_eset)$logtpm  #batch-corrected matrix
