...
```{r}
knitr::include_graphics("figures/pca_pre_log.png")
```


```{r}
knitr::include_graphics("figures/pca_post_log.png")
```
...
```{r}
knitr::include_graphics("figures/pc1_gene_list.png")
```
...
```{r}
knitr::include_graphics("figures/pca_hist.png")
```
...
```{r}
knitr::include_graphics("figures/pcd_sex.png")
```
...
```{r}
knitr::include_graphics("figures/pca_age.png")
```
...
```{r}
knitr::include_graphics("figures/kmean_clust_pca.png")
```
